...
void vendor_load_properties()
{
    ...
    if (project_name == 18857 ) {
        ...
        for (const auto &source : ro_product_props_default_source_order) {
            ...
            set_ro_product_prop(source, "device", "OnePlus7");
        ...
        if (rf_version == 4) {
            /* We are Europe */
            for (const auto &source : ro_product_props_default_source_order) {
                set_ro_product_prop(source, "model", "GM1903");
            }
            ...
            for (const auto &source : ro_product_props_default_source_order) {
                set_ro_product_prop(source, "name", "OnePlus7_EEA");
            }
            property_override("ro.build.description", "OnePlus7-user 10 QKQ1.190716.003 2003131900 release-keys");
        } else if (rf_version == 5) {
            /* We are global/US unlocked */
            for (const auto &source : ro_product_props_default_source_order) {
                set_ro_product_prop(source, "model", "GM1907");
            }
            for (const auto &source : ro_fingerprints_default_source_order) {
                set_ro_fingerprint(source, "google/coral/coral:11/RP1A.201105.002/6869500:user/release-keys");
            }
            for (const auto &source : ro_product_props_default_source_order) {
                    set_ro_product_prop(source, "name", "OnePlus7");
            }
            property_override("ro.build.description", "OnePlus7-user 10 QKQ1.190716.003 2003131900 release-keys");
        } else if (rf_version == 1) {
            /* We are China */
            for (const auto &source : ro_product_props_default_source_order) {
                set_ro_product_prop(source, "model", "GM1900");
            }
            for (const auto &source : ro_fingerprints_default_source_order) {
                set_ro_fingerprint(source, "google/coral/coral:11/RP1A.201105.002/6869500:user/release-keys");
            }
            for (const auto &source : ro_product_props_default_source_order) {
                    set_ro_product_prop(source, "name", "OnePlus7_CH");
            }
            property_override("ro.build.description", "OnePlus7-user 10 QKQ1.190716.003 2003131900 release-keys");
        } else if (rf_version == 3) {
            /* We are India */
            for (const auto &source : ro_product_props_default_source_order) {
                set_ro_product_prop(source, "model", "GM1901");
            }
            for (const auto &source : ro_fingerprints_default_source_order) {
                set_ro_fingerprint(source, "google/coral/coral:11/RP1A.201105.002/6869500:user/release-keys");
            }
